...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "private-teacher" routes for the application.
     *
     * These routes all receive session state, CSRF protection, etc.
     *
     * @return void
     */
    protected function mapPrivateTeacherRoutes()
    {
        Route::group([
            'middleware' => ['web', 'private-teacher', 'auth:private-teacher'],
            'prefix' => 'private-teacher',
            'as' => 'private-teacher.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/private-teacher.php');
        });
    }
